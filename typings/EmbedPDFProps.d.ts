...
export interface EmbedPDFContainerProps {
    ...
    catForm: boolean;
    catFormTextfield: boolean;
    catFormCheckbox: boolean;
    catFormRadio: boolean;
    catFormSelect: boolean;
    catFormListbox: boolean;
    catFormFillMode: boolean;
    catInsert: boolean;
    catInsertRubberStamp: boolean;
    catInsertSignature: boolean;
    catInsertImage: boolean;
